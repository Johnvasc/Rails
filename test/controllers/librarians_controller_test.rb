...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference("Librarian.count") do
      post librarians_url, params: { librarian: { name: @librarian.name, password: @librarian.password, user: @librarian.user } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { name: @librarian.name, password: @librarian.password, user: @librarian.user } }
